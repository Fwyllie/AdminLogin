...
--
-- Host: localhost
-- Generation Time: Feb 16, 2018 at 07:00 PM
...
--
-- Table structure for table `tbl_lockout`
--

CREATE TABLE `tbl_lockout` (
  `lock_id` int(10) UNSIGNED NOT NULL,
  `lock_ip` varchar(50) NOT NULL,
  `lock_attempts` varchar(10) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
(1, 'Fran', 'Fran', 'franfran', 'fran@fran.ca', '2018-02-09 21:20:12', '::1', '2018-02-16 01:57:58');
...
--
-- Indexes for table `tbl_lockout`
--
ALTER TABLE `tbl_lockout`
...
--
-- AUTO_INCREMENT for table `tbl_lockout`
--
ALTER TABLE `tbl_lockout`
